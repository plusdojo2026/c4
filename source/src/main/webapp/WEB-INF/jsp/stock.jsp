        ...
        <div class="wrapper">
          ...
          <%@ include file="/WEB-INF/jsp/sidebar.jsp" %>
                ...
                <table>
                  ...
                  <tbody id="stock-table-body">
                    <c:forEach var="s" items="${stockList}">
                      <tr class="stock-row" data-id="${s.id}" data-jan="${s.jancode}"
                        data-product-name="${s.productName}" data-stock-quantity="${s.stockQuantity}"
            ...
            <dialog class="stock-add-dialog">
              <form id="stock-add-form" class="stock-form" action="${pageContext.request.contextPath}/stock/add"
                method="post">
                <div class="">
                  <fieldset>
                    <legend>JANコード</legend>
                    <input type="text" name="jancode" placeholder="JANコードを入力してください。" pattern="\d{13}" maxlength="13"
            ...
            <dialog class="stock-edit-dialog">
              ...
              <form id="stock-edit-form" class="stock-form" action="${pageContext.request.contextPath}/stock/edit"
                method="post">
                ...
                <div class="">
                  ...
                  <fieldset>
                    <legend>理由</legend>
                    <textarea class="reason" name="reason" required></textarea>
                  </fieldset>
                  <div class="">
                    <fieldset>
                      <legend>入庫日</legend>
                    ...
                    <fieldset>
                      <legend>通知日</legend>
                      <input class="notifyAt" type="date" name="notifyAt">
                    </fieldset>
                  </div>
                </div>
                <div class="dialog-btn-wrapper">
